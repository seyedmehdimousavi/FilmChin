...
`;
      ...
      const goBtnLabel = card.querySelector(".go-btn .go-file-button-copy, .go-btn > span");
      ...
      const syncCollapseUi = () => {
        ...
        if (goBtnLabel) {
          goBtnLabel.textContent = goBtnLabel.classList.contains("go-file-button-copy") ? "Go to file" : uiText("goToFile");
        }
